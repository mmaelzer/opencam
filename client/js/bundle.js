...
_superagent2.default.get('/motion').end(function (err, res) {
  if (err) console.log(err);

  var motionH = document.getElementById('motionDetect');
  if (res.body.motion) {
    motionH.innerHTML = 'motion';
    motionH.style.background = 'red';
  } else {
    motionH.innerHTML = '';
    motionH.style.background = 'none';
  }
});

},{"superagent":5,"superagent-jsonapify":3}],2:[function(require,module,exports){
(function (global){
/**
 * @license
